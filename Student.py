...
#========Table Frame ===========
        ...
        # self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","dic","roll","gender","dob","emial","phone","address","taecher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
